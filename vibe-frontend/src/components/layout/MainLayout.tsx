...
export function MainLayout() {
  ...
  const isCustomStaticPage = isCreatePage || isMessagesPage || isCommunitiesPage;
  ...
  return (
    <div className={`min-h-screen w-full max-w-full transition-colors duration-300 ${
      ...
      <div className="flex w-full h-full">
        ...
        {location.pathname !== "/search" && location.pathname !== "/discover" && location.pathname !== "/create" && location.pathname !== "/messages" && location.pathname !== "/communities" && (
