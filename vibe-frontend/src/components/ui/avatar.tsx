...
>(({ className, hasStory, storyViewed, ...props }, ref) => (
  <div className={cn(
    ...
    hasStory && storyViewed && "rounded-full p-[2px] bg-muted",
  )}>
...
>(({ className, ...props }, ref) => (
  <AvatarPrimitive.Fallback
    ref={ref}
    className={cn(
      "flex h-full w-full items-center justify-center rounded-full bg-gradient-primary text-primary-foreground font-semibold",
      className
    )}
    {...props}
  />
